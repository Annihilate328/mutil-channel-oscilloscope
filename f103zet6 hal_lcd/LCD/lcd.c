...
//void LCD_ShowTitle(uint16_t x,uint16_t y,uint8_t index,uint16_t font_color,uint16_t size,uint16_t back_color)
//{ 
//	uint16_t temp,t,t1;
//	uint16_t y0=y;
//   uint8_t csize= (size*size - 64)/8;//得到字体一个字符对应点阵集所占的字节数
//	 for(t=0;t<csize;t++)
//	 { 
//			temp=hz32[index][t]; 
//		
